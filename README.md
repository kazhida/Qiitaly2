...
Qiitaly2 は、Qiita の記事を Android / iOS で読むための Kotlin Multiplatform / Compose Multiplatform アプリです。
...
Qiita OAuth の設定は、現在 `composeApp/src/commonMain/kotlin/com/abplua/qiitaly/data/repositories/AuthRepository.kt` に定義されています。
...
- iOS の URL scheme `qiitaly2` は `iosApp/iosApp/Info.plist` に登録されています。
