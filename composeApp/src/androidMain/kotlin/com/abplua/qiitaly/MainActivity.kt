...
import com.abplua.qiitaly.data.models.AuthenticatedUser
import com.abplua.qiitaly.data.models.Article
import com.abplua.qiitaly.data.repositories.AuthRepository
import com.abplua.qiitaly.data.repositories.Qiitaly2pository
import com.abplua.qiitaly.ui.App
import com.abplua.qiitaly.ui.screens.ArticleScreen
import com.abplua.qiitaly.ui.screens.LicenseScreen
import com.abplua.qiitaly.ui.screens.QUERY_OWNERS
import com.abplua.qiitaly.ui.screens.QUERY_STOCKED
import com.abplua.qiitaly.ui.screens.TimelineScreen
...
class MainActivity : ComponentActivity() {
    ...
    private lateinit var qiitaRepository: Qiitaly2pository
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        qiitaRepository = Qiitaly2pository()
        observeItemQuery()
    ...
    private fun loadItems(accessToken: String) {
        lifecycleScope.launch {
            runCatching {
                ...
                if (error is Qiitaly2pository.InvalidAccessTokenException) {
    ...
    private fun handleInvalidAccessToken(error: Qiitaly2pository.InvalidAccessTokenException) {
